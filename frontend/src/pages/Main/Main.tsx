    ...
    <div className="start_page">
      ...
      <div className="container2">
        <div className="container2-icons">
          <div className="icons">
            <h3>
              <FontAwesomeIcon icon={faPeopleGroup} size="lg" /> Best Creative
              Team
            </h3>
          </div>
          <div className="icons">
            <h3>
              <FontAwesomeIcon icon={faMagnifyingGlass} size="lg" /> Easy to
              find jobs
            </h3>
          </div>
          <div className="icons">
            <h3>
              <FontAwesomeIcon icon={faCommentDots} size="lg" /> Easy to
              comunicate
            </h3>
          </div>
          <div className="icons">
            <h3>
              <FontAwesomeIcon icon={faUserClock} size="lg" /> Fast recruitment
            </h3>
          </div>
        </div>
        <div className="container2-desc">
          ...
          <br /> Veritatis vero non doloribus est ex vel. Laboriosam at ipsum
          quaerat
          <br />
          molestias, laudantium quibusdam ad obcaecati sequi amet, doloribus
          <br />
          porro voluptatibus? Nam!
          <p />
          <button className="read-more">Read More</button>
        </div>
      </div>
